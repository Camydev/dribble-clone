        ...
        <div>
            <div className='flex h-screen'>
                ...
                <div className='md:w-3/4'>
                    <div className='mx-10 my-10 md:mx-40 md:my-20 md:w-1/3'>
                        <h2 className='text-2xl font-bold'>Sign in to Dribbble</h2>
                        <button className="w-full flex items-center justify-center gap-x-3 py-4 mt-8 border rounded-full text-sm font-medium duration-150">
                        ...
                        <div className='flex items-center justify-center my-4'>
                            ...
                            <p className='px-4'>or sign in with email</p>
                            <hr />
                        ...
                        <form
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder=""
                                    className="w-full py-4 pl-6 pr-4 text-gray-500 rounded-xl hover:outline outline-offset-2 outline-4  outline-[#EA4C89]/10 hover:shadow bg-gray-50 border border-gray-200 focus:bg-white"
                                />
                            </div>
                            ...
                            <button className="w-full flex items-center justify-center gap-x-3 py-4 mt-8 border rounded-full text-sm font-medium duration-150 bg-gray-950 text-white">
